                ...
                while (iterator.hasNext()) {  
                    ...
                    if (selectionKey.isConnectable()) {  
                        ...
                        if(count > 0){  
                            ...
                            System.out.println("Client：接收到来自Server的消息，" + receiveMessage+System.currentTimeMillis());  
                        ...
                        System.out.println("Client:客户端向服务器端发送数据--："+sendText+System.currentTimeMillis());    
                        client.register(selector, SelectionKey.OP_READ);  
